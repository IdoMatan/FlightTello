...
from TelloControl.decorators import accepts
...
class Tello:
    ...
    LOGGER = logging.getLogger('TelloControl')
    LOGGER.addHandler(HANDLER)
    LOGGER.setLevel(logging.INFO)
    # use logging.getLogger('TelloControl').setLevel(logging.<LEVEL>) in YOUR CODE
